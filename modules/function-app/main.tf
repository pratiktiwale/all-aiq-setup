...
#----------------------------------------------------------------------------------------------------------------
# 2. Service Plan (Flex Consumption - FC1 SKU)
#----------------------------------------------------------------------------------------------------------------

resource "azurerm_service_plan" "consumption" {
  name                = "aiq-funcapp-service-plan"
...
#----------------------------------------------------------------------------------------------------------------
# 5. Linux Function App with Flex Consumption
#----------------------------------------------------------------------------------------------------------------
...
resource "azurerm_linux_function_app" "main" {
  ...
  site_config {
    linux_fx_version = "PYTHON|3.11" # set your Python version here (e.g. "PYTHON|3.9" or "PYTHON|3.10")

    # Application Insights config will remain here (merge with existing lines)
  ...
  # Flex Consumption specific configuration will be in app_settings
  ...
  app_settings = merge({
    ...
    "WEBSITE_INSTANCE_MEMORY"      = "512"
    "WEBSITE_MAX_DYNAMIC_APPLICATION_SCALE_OUT" = "100"
